...
export type Theme = 'neon-blue' | 'comic-ink' | 'adam-warlock' | 'apocalypse' | 'cable' | 'captain-america' | 'cap-first-avenger' | 'convocation' | 'cyclops' | 'dark-dimension' | 'daredevil' | 'doc-ock' | 'dr-strange' | 'dracula' | 'green-goblin' | 'hellfire-club' | 'hulkbuster' | 'hydra' | 'kingpin' | 'klaw' | 'loki' | 'magik' | 'magneto' | 'mephisto' | 'midnight-sons' | 'modok' | 'mystique' | 'new-mutants' | 'onslaught' | 'professor-x' | 'sam-wilson' | 'sentinels' | 'she-hulk' | 'shield' | 'asgard' | 'miles-morales' | 'spider-man' | 'starlord' | 'storm' | 'thanos' | 'thor' | 'the-leader' | 'thunderbolts' | 'ultron' | 'weapon-x' | 'winter-guard';
  ...
  persist(
    ...
    }),
    {
      ...
      onRehydrateStorage: () => (state) => {
        ...
        if (state && !(['adam-warlock', 'apocalypse', 'cable', 'captain-america', 'cap-first-avenger', 'convocation', 'dark-dimension', 'daredevil', 'doc-ock', 'dr-strange', 'dracula', 'green-goblin', 'hellfire-club', 'hulkbuster', 'hydra', 'kingpin', 'klaw', 'loki', 'magik', 'magneto', 'mephisto', 'midnight-sons', 'modok', 'mystique', 'new-mutants', 'onslaught', 'professor-x', 'sam-wilson', 'sentinels', 'she-hulk', 'shield', 'asgard', 'miles-morales', 'spider-man', 'starlord', 'storm', 'thanos', 'thor', 'the-leader', 'thunderbolts', 'ultron', 'weapon-x', 'winter-guard'] as string[]).includes(state.theme)) {
          state.theme = 'shield';
        }
