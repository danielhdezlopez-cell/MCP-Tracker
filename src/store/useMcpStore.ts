...
export type Theme = 'neon-blue' | 'comic-ink' | 'hydra' | 'shield' | 'asgard' | 'spider-man' | 'thanos' | 'ultron';
  ...
  persist(
    ...
    }),
    {
      ...
      onRehydrateStorage: () => (state) => {
        ...
        if (state && !(['hydra', 'shield', 'asgard', 'spider-man', 'thanos', 'ultron'] as string[]).includes(state.theme)) {
          state.theme = 'shield';
        }
