...
export type Theme = 'neon-blue' | 'comic-ink' | 'apocalypse' | 'cap-first-avenger' | 'convocation' | 'cyclops' | 'dark-dimension' | 'dracula' | 'hellfire-club' | 'hulkbuster' | 'hydra' | 'mephisto' | 'midnight-sons' | 'sentinels' | 'shield' | 'asgard' | 'miles-morales' | 'spider-man' | 'thanos' | 'thunderbolts' | 'ultron' | 'weapon-x';
