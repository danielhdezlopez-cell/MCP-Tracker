...
export const LEADERS: Leader[] = [
  ...
  { id: 'crimson-dynamo', name: 'Crimson Dynamo', affiliations: ['Winter Guard'], image: img('crimson-dynamo.svg') },
  ...
  { id: 'emma-frost', name: 'White Queen', affiliations: ['Hellfire Club'], image: img('white-queen.svg') },
  ...
  { id: 'doctor-octopus', name: 'Doctor Octopus', affiliations: ['Spider Foes'], image: img('doctor-octopus.svg') },
