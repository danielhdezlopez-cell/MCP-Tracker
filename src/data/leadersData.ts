...
const cover = (file: string) => `${ASSETS_BASE}assets/leaders/covers/${file}`;

export const LEADERS: Leader[] = [
  { id: 'adam-warlock', name: 'Adam Warlock', affiliations: ['Galaxy Guardians'], image: img('AdamWarlock.png') },
  { id: 'spider-man', name: 'Amazing Spider-Man', affiliations: ['Web Warriors'], image: img('SpiderMan.png'), coverImage: cover('SpidermanCover.png') },
  { id: 'apocalypse', name: 'Apocalypse', affiliations: ['Apocalypse'], image: img('Apocalypse.png'), coverImage: cover('ApocalypseCover.png') },
  ...
  { id: 'black-panther', name: 'Black Panther', affiliations: ['Wakanda'], image: img('BlackPanther.png'), coverImage: cover('BlackPantherCover.png') },
  ...
  { id: 'cyclops', name: 'Cyclops', affiliations: ['Uncanny X-Men'], image: img('Cyclops.png'), coverImage: cover('CyclopsCover.png') },
  { id: 'daredevil', name: 'Daredevil', affiliations: ['Defenders'], image: img('Daredevil.png'), coverImage: cover('DaredevilCover.webp') },
  { id: 'doctor-strange', name: 'Doctor Strange', affiliations: ['Defenders'], image: img('DoctorStrange.png'), coverImage: cover('DrStrangeCover.png') },
  ...
  { id: 'king-tchalla', name: "King T'Challa", affiliations: ['Wakanda'], image: img('KingTChalla.webp'), coverImage: cover('BlackPanther2Cover.png') },
  ...
  { id: 'magneto', name: 'Magneto', affiliations: ['Brotherhood'], image: img('Magneto.png'), coverImage: cover('MagnetoCover.png') },
  ...
  { id: 'mephisto', name: 'Mephisto', affiliations: ['Mephisto'], image: img('Mephisto.png'), coverImage: cover('MephistoCover.png') },
  { id: 'miles-morales', name: 'Miles Morales', affiliations: ['Web Warriors'], image: img('MilesMorales.png'), coverImage: cover('MilesMoralesCover.png') },
  ...
  { id: 'doctor-octopus', name: 'Doctor Octopus', affiliations: ['Spider Foes'], image: img('doctor-octopus.png'), coverImage: cover('DoctorOctopusCover.png') },
  { id: 'onslaught', name: 'Onslaught', affiliations: ["Onslaught's Grip"], image: img('Onslaught.png') },
  { id: 'professor-xavier', name: 'Professor X', affiliations: ['Uncanny X-Men'], image: img('ProfessorX.png'), coverImage: cover('ProfessorXCover.png') },
  ...
  { id: 'thanos', name: 'Thanos', affiliations: ['Black Order'], image: img('Thanos.png'), coverImage: cover('ThanosCover.png') },
  { id: 'thor', name: 'Thor', affiliations: ['Asgard'], image: img('Thor.png') },
  { id: 'weapon-x', name: 'Weapon X', affiliations: ['Weapon X'], image: img('WeaponXWolverine.png'), coverImage: cover('LoganCover.png') },
];
