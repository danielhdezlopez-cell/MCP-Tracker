...
export const VIDEO_THEMES: Partial<Record<Theme, VideoThemeEntry>> = {
  ...
  'doc-ock':           { src: `${ASSETS_BASE}assets/backgrounds/BG_DocOck.mp4`,                     modifier: 'anim-theme-bg--doc-ock', objectPositionY: '65%', scale: 1.1 },
  ...
  'miles-morales': { src: `${ASSETS_BASE}assets/backgrounds/BG_MilesMorales.mp4`, modifier: 'anim-theme-bg--miles-morales', smoothLoop: true, scale: 1.3 },
