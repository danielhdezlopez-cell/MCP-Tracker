...
export const VIDEO_THEMES: Partial<Record<Theme, VideoThemeEntry>> = {
  ...
  'doc-ock':           { src: `${ASSETS_BASE}assets/backgrounds/BG_DocOck.mp4`,                     modifier: 'anim-theme-bg--doc-ock', objectPositionY: '30%' },
  ...
  namor:               { src: `${ASSETS_BASE}assets/backgrounds/BG_Namor.mp4`,                   modifier: 'anim-theme-bg--namor',             smoothLoop: true, objectPositionY: '35%' },
