...
export const VIDEO_THEMES: Partial<Record<Theme, VideoThemeEntry>> = {
  ...
  'black-bolt':    { src: `${ASSETS_BASE}assets/backgrounds/BG_BlackBolt.mp4`,    modifier: 'anim-theme-bg--black-bolt',    smoothLoop: true, scale: 1.2 },
  ...
  'doc-ock':           { src: `${ASSETS_BASE}assets/backgrounds/BG_DocOck.mp4`,                     modifier: 'anim-theme-bg--doc-ock', objectPositionY: '50%' },
  'dr-strange':        { src: `${ASSETS_BASE}assets/backgrounds/BG_DrStrange.mp4`,                  modifier: 'anim-theme-bg--dr-strange', objectPositionY: '0%' },
  ...
  'green-goblin':      { src: `${ASSETS_BASE}assets/backgrounds/BG_GreenGoblin.mp4`,              modifier: 'anim-theme-bg--green-goblin', smoothLoop: true, objectPositionY: '5%' },
  ...
  namor:               { src: `${ASSETS_BASE}assets/backgrounds/BG_Namor.mp4`,                   modifier: 'anim-theme-bg--namor',             smoothLoop: true, objectPositionY: '0%' },
  ...
  'baron-strucker':       { src: `${ASSETS_BASE}assets/backgrounds/BG_BaronStrucker.mp4`,      modifier: 'anim-theme-bg--baron-strucker', smoothLoop: true, objectPositionY: '10%' },
