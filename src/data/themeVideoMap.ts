...
export const VIDEO_THEMES: Partial<Record<Theme, VideoThemeEntry>> = {
  ...
  'black-bolt':    { src: `${ASSETS_BASE}assets/backgrounds/BG_BlackBolt.mp4`,    modifier: 'anim-theme-bg--black-bolt',    smoothLoop: true, scale: 1.1 },
  ...
  cyclops:             { src: `${ASSETS_BASE}assets/backgrounds/BG_Cyclops.mp4`,                    modifier: 'anim-theme-bg--cyclops', smoothLoop: true, scale: 1.1 },
  ...
  'dr-strange':        { src: `${ASSETS_BASE}assets/backgrounds/BG_DrStrange.mp4`,                  modifier: 'anim-theme-bg--dr-strange', objectPositionY: '15%' },
  ...
  'green-goblin':      { src: `${ASSETS_BASE}assets/backgrounds/BG_GreenGoblin.mp4`,              modifier: 'anim-theme-bg--green-goblin', smoothLoop: true, objectPositionY: '20%' },
  ...
  'winter-guard': { src: `${ASSETS_BASE}assets/backgrounds/BG_WinterGuard.mp4`, modifier: 'anim-theme-bg--winter-guard', objectPositionY: '40%' },
