...
// Assets are served from the original MCP-Tracker GitHub Pages deployment.
...
const VIDEO_THEMES: Partial<Record<Theme, { src: string; modifier: string; smoothLoop?: boolean }>> = {
  ...
  'black-bolt':    { src: `${ASSETS_BASE}assets/backgrounds/BG_BlackBolt.mp4`,    modifier: 'anim-theme-bg--black-bolt',    smoothLoop: true },
  ...
  'captain-america':   { src: `${ASSETS_BASE}assets/backgrounds/BG_CaptainAmerica.mp4`,            modifier: 'anim-theme-bg--captain-america' },
  ...
  'doc-ock':           { src: `${ASSETS_BASE}assets/backgrounds/BG_DocOck.mp4`,                     modifier: 'anim-theme-bg--doc-ock'           },
  ...
  'emma-frost':        { src: `${ASSETS_BASE}assets/backgrounds/BG_EmmaFrost2.mp4`,               modifier: 'anim-theme-bg--emma-frost',         smoothLoop: true },
  'green-goblin':      { src: `${ASSETS_BASE}assets/backgrounds/BG_GreenGoblin.mp4`,              modifier: 'anim-theme-bg--green-goblin', smoothLoop: true },
  ...
  namor:               { src: `${ASSETS_BASE}assets/backgrounds/BG_Namor.mp4`,                   modifier: 'anim-theme-bg--namor',             smoothLoop: true },
  ...
  klaw:   { src: `${ASSETS_BASE}assets/backgrounds/BG_Klaw.mp4`,        modifier: 'anim-theme-bg--klaw', smoothLoop: true },
  loki:    { src: `${ASSETS_BASE}assets/backgrounds/BG_Loki.mp4`,     modifier: 'anim-theme-bg--loki', smoothLoop: true },
  magik:   { src: `${ASSETS_BASE}assets/backgrounds/BG_Magik.mp4`,    modifier: 'anim-theme-bg--magik', smoothLoop: true },
  ...
  onslaught:       { src: `${ASSETS_BASE}assets/backgrounds/BG_Onslaught.mp4`,   modifier: 'anim-theme-bg--onslaught', smoothLoop: true  },
  ...
  'winter-guard': { src: `${ASSETS_BASE}assets/backgrounds/BG_WinterGuard.mp4`, modifier: 'anim-theme-bg--winter-guard' },
  'adam-warlock': { src: `${ASSETS_BASE}assets/backgrounds/BG_AdamWarlock.mp4`, modifier: 'anim-theme-bg--adam-warlock', smoothLoop: true },
  'red-skull':                     { src: `${ASSETS_BASE}assets/backgrounds/BG_RedSkull.mp4`,                    modifier: 'anim-theme-bg--red-skull',                    smoothLoop: true },
  'red-skull-master-of-hydra':     { src: `${ASSETS_BASE}assets/backgrounds/BG_RedSkullMasterOfHydra.mp4`,     modifier: 'anim-theme-bg--red-skull-master-of-hydra',     smoothLoop: true },
  ...
  'baron-strucker':       { src: `${ASSETS_BASE}assets/backgrounds/BG_BaronStrucker.mp4`,      modifier: 'anim-theme-bg--baron-strucker', smoothLoop: true },
  ...
  'nick-fury':            { src: `${ASSETS_BASE}assets/backgrounds/BG_NickFury.mp4`,            modifier: 'anim-theme-bg--nick-fury', smoothLoop: true },
...
/** Return the video source URL for a given theme, or null if no video exists. */
